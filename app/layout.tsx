...
export const metadata: Metadata = {
  title: "Audiophile",
  description: "A frontend porfolio project by joshbraham.",
};
  ...
  return (
    <html lang="en">
      <body className={`${manrope.className} bg-black`}>
        <header className="relative z-10 grid gap-11 items-center grid-cols-header lg:grid-cols-header-lg px-6 py-8 md:px-10 xl:px-[165px]">
          <a
            href="#maincontent"
            className="absolute first-cell self-start px-2 py-1 bg-primary text-white z-50 opacity-0 pointer-events-none focus:opacity-100 focus:pointer-events-auto"
          >
          ...
          <Link
            href="/"
            aria-label="home"
            className="focus-outline-primary group justify-self-center md:justify-self-start"
          >
            <svg
              aria-hidden="true"
              className="w-[143px] h-[25px] fill-white transition-colors group-hover:fill-primary"
            >
              <use href="#logo"></use>
            </svg>
          </Link>
                ...
                (pageName) => (
                  <li key={pageName}>
                    <Link
                      ...
                      className="focus-outline-primary transition-colors hover:text-primary"
                    >
          ...
          <button
            aria-label="cart"
            className="focus-outline-primary group md:ml-auto xl:ml-0 justify-self-end"
          >
            <svg
              aria-hidden="true"
              className="w-[23px] h-5 fill-white transition-colors group-hover:fill-primary"
            >
              <use href="#cart"></use>
            </svg>
          </button>
        ...
        <footer className="text-white bg-neutral-925 px-6 md:px-10 xl:px-[165px] pt-[52px] md:pt-[60px] xl:pt-[75px] pb-[38px] md:pb-[46px] xl:pb-12 space-y-12 md:space-y-0 relative before:absolute before:bg-primary before:w-[101px] before:h-1 before:top-0 before:left-1/2 md:before:left-10 xl:before:left-[165px] before:-translate-x-1/2 md:before:translate-x-0 md:grid md:grid-cols-[1fr_auto] md:gap-y-8">
          <Link
            href="/"
            aria-label="home"
            className="focus-outline-primary group block w-fit mx-auto md:m-0"
          >
            <svg
              aria-hidden="true"
              width="143"
              height="25"
              className="fill-white transition-colors group-hover:fill-primary"
            >
              <use href="#logo"></use>
            </svg>
          </Link>
